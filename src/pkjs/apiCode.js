...
function getSteamInfo()
{
  ...
  console.log("http://api.steampowered.com/ISteamUser/GetPlayerSummaries/v0002?key=BE21C3BE3D080E95DE1D946923C6D99C&steamids=".concat(combString));
...
function getFriendsInfo()
{
  ...
  console.log("http://api.steampowered.com/ISteamUser/GetFriendList/v0001/?key=BE21C3BE3D080E95DE1D946923C6D99C&steamid=".concat(combString + "&relationship=friend"));
...
Pebble.addEventListener('showConfiguration', function(e){Pebble.openURL('http://steam.hullsoftworks.com:26648/');});
